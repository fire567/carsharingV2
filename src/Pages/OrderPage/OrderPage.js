        ...
        <div className={classes.order_page_form}>
            ...
            <div className={classes.page_form}>
                ...
                <div className={classes.order_page_content_form}>
                    ...
                    <OrderInfMobile setIsMobileOpened={setIsMobileOpened} infMobileOpened={infMobileOpened}/>
                </div>
                <div className={infMobileOpened ? classes.mobile_inf_btn_closed : classes.mobile_inf_btn} onClick={() => openMenuHandler()}>
